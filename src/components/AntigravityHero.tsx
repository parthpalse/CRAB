  ...
  return (
    <>
      ...
      <nav style={{ 
        ...
        right: 0, 
        zIndex: 40, 
        height: isMobile ? scaled(38, scale) : scaled(64, scale), 
        display: 'grid', 
        gridTemplateColumns: isMobile ? 'auto 1fr auto' : isTablet ? 'auto 1fr auto' : '1fr auto 1fr', 
        columnGap: isMobile ? scaled(6, scale) : '0px',
        alignItems: 'center', 
        padding: isMobile ? `0 ${scaled(6, scale)}` : isTablet ? '0 32px' : '0 2vw', 
        ...
        >
          <img 
            ...
            alt="Klarstone" 
            style={{ 
              height: isMobile ? scaled(28, scale) : scaled(44, scale),
              width: 'auto',
        ...
        <div style={{ 
          display: 'flex', 
          gap: isMobile ? scaled(8, scale) : '32px', 
          alignItems: 'center', 
          justifyContent: 'flex-end', 
          fontSize: isMobile ? scaled(10, scale) : '13px', 
          color: muted, 
          fontFamily: 'Inter, sans-serif', 
          fontWeight: 300,
          transition: 'background 0.3s ease, color 0.3s ease',
          ...
          <div
            ...
            style={{
              width: isMobile ? scaled(32, scale) : '36px',
              height: isMobile ? scaled(18, scale) : '20px',
              borderRadius: isMobile ? scaled(9, scale) : '10px',
          ...
          >
            <div style={{
              ...
              left: isDark ? (isMobile ? scaled(16, scale) : '18px') : (isMobile ? scaled(2, scale) : '2px'),
              width: isMobile ? scaled(14, scale) : '16px',
              height: isMobile ? scaled(14, scale) : '16px',
              borderRadius: '50%',
              background: '#ffffff',
      ...
      <div style={{ position: 'fixed', inset: 0, zIndex: 0, background: isDark ? 'radial-gradient(80% 60% at 50% 50%, #1a1a1a 0%, #0a0a0a 60%, #000 100%)' : 'radial-gradient(80% 60% at 50% 50%, #dbeff8 0%, #e8f2f7 50%, #F5F5F5 100%)', pointerEvents: 'none' }} />
      ...
      <div style={{ position: 'fixed', inset: 0, zIndex: 1, pointerEvents: 'none', opacity: scrolled ? 0 : 1, transition: 'opacity 0.25s ease' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, background: isDark ? 'radial-gradient(70% 60% at 50% 50%, transparent 0%, rgba(0,0,0,0.55) 75%, rgba(0,0,0,0.95) 100%), linear-gradient(180deg, transparent 60%, rgba(0,0,0,0.8) 100%)' : 'radial-gradient(70% 60% at 50% 50%, transparent 0%, rgba(245,245,245,0.3) 75%, rgba(245,245,245,0.7) 100%)' }} />
