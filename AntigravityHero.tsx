...
export default function AntigravityHero() {
  ...
  return (
    <>
      ...
      {/* Canvas layer — fades out on scroll */}
      ...
      {/* MagicBento section — appears after hero on scroll */}
      <div style={{ position:'relative', zIndex:8, background:'#0A0A0A', display:'flex', justifyContent:'center', alignItems:'center', padding:'80px 32px 120px' }}>
        <MagicBento
          textAutoHide={true}
          enableStars={true}
